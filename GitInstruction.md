...
Для создания локального репозитория сначала создаем папку и даем ей любое понятное нам название,после открываем в VSC эту папку и создаем в ней файл и также даем ему имя и формат.
После в терминал пишем команду ``` git init ```
Теперь наш локальный репозиторий создан и инициализирован!
